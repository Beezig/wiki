...
This feature only works on the 5zig version. LabyMod handles ChatComponent packets differently.Only the official chat-report-reasons, as seen on the report form, are valid.
